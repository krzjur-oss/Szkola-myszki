...
🔗 **[► Uruchom grę](https://TWOJA-NAZWA.github.io/szkola-myszki/)**
...
- ⭐ **System gwiazdek** i punktów zapisywany lokalnie w przeglądarce
- 📊 **Statystyki**: dokładność, trafienia, pudła po każdej rundzie
- 📱 **Obsługa dotyku** — działa na tabletach i ekranach dotykowych
- 🚫 **Zero instalacji** — wystarczy otworzyć w przeglądarce

## 🚀 Uruchomienie lokalnie

Pobierz plik `index.html` i otwórz go w dowolnej przeglądarce (Chrome, Edge, Firefox).  
Nie wymaga serwera ani połączenia z internetem.

## 🏫 Dla nauczycieli

Udostępnij uczniom link do strony GitHub Pages. Każdy uczeń ma własne statystyki zapisywane lokalnie na jego urządzeniu — nie są przesyłane nigdzie do sieci.
